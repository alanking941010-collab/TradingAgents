...
def _render_markdown(
    *,
    ...
    lines = [
        f"# {title}",
        "",
        "## Volatility Snapshot / Volatility Surface",
        ...
        f"- Term regime: `{(analytics.get('vol_surface') or {}).get('term_regime', {}).get('shape')}`",
